...
export const batchContractAddress2 = "0x2bdCC0de6bE1f7D2ee689a0342D76F52E8EFABa3"
export const batchArtifact = JSON.parse(fs.readFileSync('./contractArtifacts/Batch.json', 'utf8')) as any;
